...
'''
print("                                Experiment1.1:  Cross val for learningrate and seed                                \n")
...
for seed in [1, 2, 3, 4, 5]:
    for lr in [3e-4, 1e-4, 3e-5, 1e-5]:
        for val_fold in [1, 2, 3, 4, 5]:
            ...
            expid = f"experiment1.1_cv={val_fold}_std_train_lr=={lr}_seed=={seed}_batch==16_train_layer==all_time=={expid_time}"
            seed = seed
            ...
            print(
                "\n                                Experiment1.1 Required parameters:{}                                \n".format(train_args))

        '''Create dataset and loader'''
        print(
            "\n                                Experiment1.1 Create Dataset And Loader:                                 \n")
        ...
        if do_eval_model:
            ...
            print("\n                                  Experiment1.1 cv={}_std_train_lr=={}_seed=={}Accaury:{}                                  \n".format(val_fold,lr,seed,accs))