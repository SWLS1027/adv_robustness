    ...
    for lr in [...]:
        for eps in [1, 3, 4, 9]:
            for val_fold in [0]:
                ...
                # Model
                base_model_expid =f"experiment1.3_cv={...}_adv=={eps}_train_lr=={lr}_seed=={seed}_batch==16_train_layer==all_time=={...}"
                ...
                expid = f"experiment1.4_cv={val_fold}_adv=={eps}_train_lr=={lr}_seed=={seed}_batch==16_train_layer==all_time=={expid_time}"
                seed = seed
                ...
                print(
                    "\n                                Experiment1.4 First Name:{}                                \n".format(
                        expid))

                fix_random_seed(seed)
                out_store = cox.store.Store(OUT_DIR, expid)
                print(
                    "\n                                Experiment1.4 Out_Store:{}                                \n".format(
                        out_store.exp_id))
                ...
                print(
                    "\n                                Experiment1.4 Required parameters:{}                                \n".format(
                        train_args))

            '''Create dataset and loader'''
            print(
                "\n                                Experiment1.4 Create Dataset And Loader:                                 \n")
            ...
            if do_eval_model:
                ...
                print(
                    "\n                                  Experiment1.4 cv={}_adv=={}_train_lr=={}_seed=={}Accaury:{}                                  \n".format(
                        val_fold, eps, lr, seed, accs))
