...
'''
print("                                Experiment1.2:  Std train all dataset                                \n")
...
for seed in [...]:
    for lr in [1e-5]:
        for val_fold in [0]:
            ...
            # Model
            base_model_expid = f"experiment1.1_cv={...}_std_train_lr=={...}_seed=={seed}_batch==16_train_layer==all_time=={...}"
            ...
            expid = f"experiment1.2_std_lr=={lr}_seed=={seed}_train_all_dataset_time=={expid_time}"
            seed = seed
            ...
            print(
                "\n                                Experiment1.2 First Name:{}                                \n".format(expid))

            fix_random_seed(seed)
            out_store = cox.store.Store(OUT_DIR, expid)
            print("\n                                Experiment1.2 Out_Store:{}                                \n".format(
                out_store.exp_id))
            ...
            print(
                "\n                                Experiment1.2 Required parameters:{}                                \n".format(train_args))

        '''Create dataset and loader'''
        print(
            "\n                                Experiment1.2 Create Dataset And Loader:                                 \n")
        ...
        if do_eval_model:
            ...
            print("\n                                  Experiment1.2 std_train_all_dataset_lr=={}_seed=={}Accaury:{}                                  \n".format(val_fold,lr,seed,accs))
